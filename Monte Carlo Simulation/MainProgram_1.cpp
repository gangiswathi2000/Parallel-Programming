...
main( int argc, char *argv[ ] )
{
	...
	for( int tries = 0; tries < NUMTRIES; tries++ )
	{
		...
		numHits = 0;
		float v, thr, vx, vy, g, h, d, t, x, y;
        float A, B, C, disc, sqrtdisc, t1, t2, tmax, upperDist;
		#pragma omp parallel for default(none) private(v, thr, vx, vy, g, h, d, t, x, y, A, B, C, disc, sqrtdisc, t1, t2, tmax, upperDist) shared(vs, ths, gs, hs, ds,stderr) reduction(+:numHits)
		for( int n = 0; n < NUMTRIALS; n++ )
		{
